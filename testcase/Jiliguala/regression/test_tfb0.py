...
class Testpossessweeks(object):
    ...
    def test_Tfb0(self):
        ...
        resp2 = self.possessweeks1.api_order_create_V2(itemid=self.CS_user["itemid"],url=self.CS_user["url3"], sp2xuIds=self.CS_user["sp2xuIds"],
        ...
        # 传入oid获取商品信息
        resp3 = self.possessweeks1.api_order_charge_V2(order=oid, extra=self.CS_user["extra3"])
        assert resp3["code"] == 0
